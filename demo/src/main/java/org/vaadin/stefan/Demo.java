...
public class Demo extends Div {
    ...
    public Demo() {
        HorizontalLayout title = new HorizontalLayout(new H3("full calendar demo"), new Span("(FullCalendar addon: 1.3.0-SNAPSHOT, FullCalendar Scheduler extension: 1.0.0-SNAPSHOT)"));
