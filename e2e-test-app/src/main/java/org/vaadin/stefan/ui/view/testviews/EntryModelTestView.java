...
public class EntryModelTestView extends VerticalLayout {
    ...
    public EntryModelTestView() {
        ...
        // Note: setUrl() is a V7 API — not available in V6; omitting for backport compatibility.
        ...
        // Note: setInteractive() is a V7 API — not available in V6; omitting for backport compatibility.
