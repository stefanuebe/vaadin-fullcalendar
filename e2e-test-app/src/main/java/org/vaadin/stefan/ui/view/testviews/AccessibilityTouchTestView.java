...
public class AccessibilityTouchTestView extends VerticalLayout {
    ...
    public AccessibilityTouchTestView() {
        ...
        // Enable native toolbar so buttonHints has buttons to label.
        // The addon disables headerToolbar by default; this view needs it for its buttonHints tests.
        var left = new org.vaadin.stefan.fullcalendar.model.HeaderFooterPart(org.vaadin.stefan.fullcalendar.model.HeaderFooterPartPosition.START);
        left.addItem(org.vaadin.stefan.fullcalendar.model.HeaderFooterItem.BUTTON_PREVIOUS);
        left.addItem(org.vaadin.stefan.fullcalendar.model.HeaderFooterItem.BUTTON_NEXT);
        left.addItem(org.vaadin.stefan.fullcalendar.model.HeaderFooterItem.BUTTON_TODAY);
        var center = new org.vaadin.stefan.fullcalendar.model.HeaderFooterPart(org.vaadin.stefan.fullcalendar.model.HeaderFooterPartPosition.CENTER);
        center.addItem(org.vaadin.stefan.fullcalendar.model.HeaderFooterItem.TITLE);
        var right = new org.vaadin.stefan.fullcalendar.model.HeaderFooterPart(org.vaadin.stefan.fullcalendar.model.HeaderFooterPartPosition.END);
        calendar.setHeaderToolbar(new org.vaadin.stefan.fullcalendar.model.Header(java.util.List.of(left, center, right)));

        // Accessibility options
        // Note: eventInteractive (ENTRY_INTERACTIVE) is a V7 option — not available in V6.
        ...
        // Note: nativeToolbarButtonHints (NATIVE_TOOLBAR_BUTTON_HINTS) is a V7 option — not available in V6.
