...
- **Java 17 / Vaadin 24.10**: This is the v6 backport branch. It targets Java 17 and Vaadin 24.10.x. Version 7 (master) requires Java 21 and Vaadin 25.x.
- **Light DOM**: The component uses light DOM (not shadow DOM) for easier CSS styling and FullCalendar compatibility.
- **elemental.json**: JSON serialization uses elemental.json (provided by Vaadin Flow). Custom converters in the `converters/` package handle Java ↔ JS type mapping.
