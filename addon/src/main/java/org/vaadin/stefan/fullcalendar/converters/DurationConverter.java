 ...
 * accept this format.
 */
public class DurationConverter<T> implements JsonItemPropertyConverter<Object, T> {
    ...
    public JsonValue toClientModel(Object serverValue, T currentInstance) {
        ...
        if (serverValue instanceof LocalTime) {
            return JsonUtils.toJsonValue(((LocalTime) serverValue).format(LOCAL_TIME_FORMAT));
        }
